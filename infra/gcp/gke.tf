...
resource "google_container_cluster" "primary" {
  ...
  # We use the default node pool to avoid the "create default -> delete default -> create custom" cycle.
  # By defining the node_pool block here (and keeping remove_default_node_pool = true to clean up the implicit one),
  # we ensure the cluster is created with our desired pool in one step.
